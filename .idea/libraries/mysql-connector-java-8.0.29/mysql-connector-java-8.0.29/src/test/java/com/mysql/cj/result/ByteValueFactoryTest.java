...
public class ByteValueFactoryTest extends CommonAsserts {
    ...
    public void testCreateFromDate() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from DATE to java.lang.Byte", new Callable<Void>() {
            @Override
    ...
    public void testCreateFromTime() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from TIME to java.lang.Byte", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromTimestamp() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from TIMESTAMP to java.lang.Byte", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromLong() {
        ...
        CommonAsserts.assertThrows(NumberOutOfRange.class, "Value '128' is outside of valid range for type java.lang.Byte", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
        ...
        CommonAsserts.assertThrows(NumberOutOfRange.class, "Value '-129' is outside of valid range for type java.lang.Byte", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromBigInteger() {
        ...
        CommonAsserts.assertThrows(NumberOutOfRange.class, "Value .+ is outside of valid range for type java.lang.Byte", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromBytes() {
        ...
        CommonAsserts.assertThrows(NumberOutOfRange.class, "Value '-1.0' is outside of valid range for type java.lang.Byte", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
        ...
        CommonAsserts.assertThrows(NumberOutOfRange.class, "Value '1e0' is outside of valid range for type java.lang.Byte", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
        ...
        CommonAsserts.assertThrows(NumberOutOfRange.class, "Value '123' is outside of valid range for type java.lang.Byte", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
        ...
        CommonAsserts.assertThrows(NumberOutOfRange.class, "Value 'just a string' is outside of valid range for type java.lang.Byte", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
