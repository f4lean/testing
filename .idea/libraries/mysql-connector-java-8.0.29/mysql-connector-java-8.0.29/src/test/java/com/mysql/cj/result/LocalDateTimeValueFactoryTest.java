...
public class LocalDateTimeValueFactoryTest extends CommonAsserts {
    ...
    public void testCreateFromTime() {
        CommonAsserts.assertThrows(DataReadException.class,
    ...
    public void testCreateFromTimestamp() {
        CommonAsserts.assertThrows(DataReadException.class, "Zero date value prohibited", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
        ...
        CommonAsserts.assertThrows(DateTimeException.class, "Invalid value for MonthOfYear \\(valid values 1 - 12\\): 0", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
        ...
        CommonAsserts.assertThrows(DateTimeException.class, "Invalid value for DayOfMonth \\(valid values 1 - 28/31\\): 0", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromLong() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from LONG to java.time.LocalDateTime", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromBigInteger() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from BIGINT to java.time.LocalDateTime", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromDouble() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from DOUBLE to java.time.LocalDateTime", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromBigDecimal() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from DECIMAL to java.time.LocalDateTime", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromBytes() {
        ...
        CommonAsserts.assertThrows(DataConversionException.class, "Cannot convert string '' to java.time.LocalDateTime value", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
                LocalDateTimeValueFactoryTest.this.vf.createFromBytes("".getBytes(), 0, 0, f);
                return null;
        ...
        CommonAsserts.assertThrows(DataConversionException.class, "Cannot convert string '1' to java.time.LocalDateTime value", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
        ...
        CommonAsserts.assertThrows(DataConversionException.class, "Cannot convert string '-1.0' to java.time.LocalDateTime value", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
        ...
        CommonAsserts.assertThrows(DataConversionException.class, "Cannot convert string 'just a string' to java.time.LocalDateTime value", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromBit() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from BIT to java.time.LocalDateTime", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
