...
public class IntegerValueFactoryTest extends CommonAsserts {
    ...
    public void testCreateFromDate() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from DATE to java.lang.Integer", new Callable<Void>() {
            @Override
    ...
    public void testCreateFromTime() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from TIME to java.lang.Integer", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromTimestamp() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from TIMESTAMP to java.lang.Integer", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromLong() {
        ...
        CommonAsserts.assertThrows(NumberOutOfRange.class, "Value '2147483648' is outside of valid range for type java.lang.Integer", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
        ...
        CommonAsserts.assertThrows(NumberOutOfRange.class, "Value '-2147483649' is outside of valid range for type java.lang.Integer", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromBigInteger() {
        ...
        CommonAsserts.assertThrows(NumberOutOfRange.class, "Value .+ is outside of valid range for type java.lang.Integer", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromBytes() {
        ...
        CommonAsserts.assertThrows(DataConversionException.class, "Cannot determine value type from string ''", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
        ...
        CommonAsserts.assertThrows(DataConversionException.class, "Cannot determine value type from string 'just a string'", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
