...
public class LongValueFactoryTest extends CommonAsserts {
    ...
    public void testCreateFromDate() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from DATE to java.lang.Long", new Callable<Void>() {
            @Override
    ...
    public void testCreateFromTime() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from TIME to java.lang.Long", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromTimestamp() {
        CommonAsserts.assertThrows(DataConversionException.class, "Unsupported conversion from TIMESTAMP to java.lang.Long", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
    ...
    public void testCreateFromBigInteger() {
        ...
        CommonAsserts.assertThrows(NumberOutOfRange.class, "Value .+ is outside of valid range for type java.lang.Long", new Callable<Void>() {
            @Override
            public Void call() throws Exception {
